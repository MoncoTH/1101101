...
<TR><TD> Firstname:</TD><TD><input type="text" name="firstname" maxlength"10" size="20" onchange="searchName(this.value)"></TD></TR>
<TR><TD> Lastname: </TD><TD><input type="text" name="lastname" id="v1" maxlength="10" size="20"></TD></TR>
<TR><TD> Age: </TD><TD><input type="number" name="age" id="v2" min="1" max="100"></TD></TR>
<TR><TD>Gender:</TD><TD>
